...
function(a) {
    ...
    c.VERSION = "3.2.0", c.DEFAULTS = { interval: 5e3, pause: "hover", wrap: !0 }, c.prototype.keydown = function(a) {
        ...
        if (!(b > this.$items.length - 1 || b < 0)) return this.sliding ? this.$element.one("slid.bs.carousel", function() { c.to(b) }) : d == b ? this.pause().cycle() : this.slide(b > d ? "next" : "prev", a(this.$items[b]))
...
function(a) {
    ...
    c.VERSION = "3.2.0", c.DEFAULTS = { toggle: !0 }, c.prototype.dimension = function() { return this.$element.hasClass("width") ? "width" : "height" }, c.prototype.show = function() {
...
function(a) {
    ...
    c.VERSION = "3.2.0", c.DEFAULTS = { animation: !0, placement: "top", selector: !1, template: '<div class="tooltip" role="tooltip"><div class="tooltip-arrow"></div><div class="tooltip-inner"></div></div>', trigger: "hover focus", title: "", delay: 0, html: !1, container: !1, viewport: { selector: "body", padding: 0 } }, c.prototype.init = function(b, c, d) {
        ...
        c.timeout = setTimeout(function() { "in" == c.hoverState && c.show() }, c.options.delay.show)
...
function() {
    ...
    }, a.isRetina = function() { return e.devicePixelRatio > 1 || !(!e.matchMedia || !e.matchMedia("(-webkit-min-device-pixel-ratio: 1.5), (min--moz-device-pixel-ratio: 1.5), (-o-min-device-pixel-ratio: 3/2), (min-resolution: 1.5dppx)").matches) };
    var g = /\.\w+$/;
...
function(a) {
    if ("function" == typeof define && define.amd) define(a);
        ...
        var b = window.Cookies,
            c = window.Cookies = a();
        c.noConflict = function() { return window.Cookies = b, c }
    }
}(function() {
    ...
    function b(c) {
        function d(b, e, f) {
            ...
            for (var i = document.cookie ? document.cookie.split("; ") : [], j = /(%[0-9A-Z]{2})+/g, k = 0; k < i.length; k++) {
                ...
                try {
                    if (n = c.read ? c.read(n, m) : c(n, m) || n.replace(j, decodeURIComponent), this.json) try { n = JSON.parse(n) } catch (a) {}
                    if (b === m) { g = n; break }
                    b || (g[m] = n)
                } catch (a) {}
            }
        ...
        return d.get = d.set = d, d.getJSON = function() { return d.apply({ json: !0 }, [].slice.call(arguments)) }, d.defaults = {}, d.remove = function(b, c) { d(b, "", a(c, { expires: -1 })) }, d.withConverter = b, d
    }
    return b(function() {})
}),
function(a) {
    var b = {
            common: {
                init: function() {
                    ...
                    function c(b, c) { a(b + ' input[type="submit"]').click(function() { a(document).on("mailsent.wpcf7", function() { j || (ga("send", "event", "Newsletter Signup", "submit", c), j = !0) }) }) }
                    ...
                    a(".cookie-bar .dismiss").click(function() { a(".cookie-bar").slideUp(100), Cookies.set("touBanner", "true", { expires: 365 }), ga("send", "event", "TOU Banner", "click", "x-out") });
                    var e = Cookies.get("touBanner");
                    a(window).load(function() { "true" !== e ? a(".cookie-bar").show() : "true" === e && a(".cookie-bar").hide() }), a(".accordion-group").click(function(b) { a(".collapse.in").collapse("hide") }), document.addEventListener("wpcf7mailsent", function(b) { "14249" === b.detail.contactFormId && (a(".signup-label").hide(), a(".thank-you").show(), a(".form").hide(), a(".signup").hide()), "17503" === b.detail.contactFormId && (a(".newsletter-signup-row").css("opacity", 0), a(".newsletter-row-wrapper .thank-you").css("opacity", 1)) }, !1), a(".wpcf7-form").on("focusout", ".wpcf7-form-control", function() { a(".wpcf7-not-valid-tip", a(this).parent()).length && "" !== a(this).val() && (a(".wpcf7-not-valid-tip", a(this).parent()).remove(), a(".wpcf7-not-valid-tip", a(this).removeClass("wpcf7-not-valid"))) }), a(".navbar-collapse").css({ maxHeight: a(window).height() - a(".navbar-header").height() + "px" }), a(".search-form").submit(function(b) { a(this).find("#search").val(a.trim(a(this).find("#search").val())).val() || (b.preventDefault(), a("#search").prop("placeholder", "Please enter a search term"), a("#search").focus()) }), a(".menu-contact a").click(function() { ga("send", "event", "Header-Contact-Button", "click") }), a(".content-info li.menu-contact-us").click(function() { ga("send", "event", "Contact Us", "click", "footer-link") }), a(".content-info li.menu-insights").click(function() { ga("send", "event", "Insights", "click", "footer-link") }), a(".suggested_post").click(function() {
                        var b = a(this).index();
                    ...
                    }), b("main-content", "Bottom CTA"), b("header_text_wrapper", "Hero CTA"), a("#newsletterModal").on("hidden.bs.modal", function() { Cookies.set("shouldDisplayModal", "false", { expires: 7 }) });
                    var f = Cookies.get("shouldDisplayModal"),
                        g = Cookies.get("shouldDisplayModalSubscribed");
                    a(window).load(function() { a(document).width() > 767 && "false" !== f && "false" !== g && setTimeout(function() { a("#newsletterModal").modal("show") }, 3e3) }), a(".close-x").click(function() { a(".newsletter-banner").remove() }), a(".close-x-fly").click(function() { a(".flyout-banner").remove() }), a(".x-out").click(function() { a(".build_callout_nav").slideUp(100), Cookies.set("bankBanner", "false", { expires: 365 }), ga("send", "event", "Dev Center Banner", "click", "x-out") }), a(".copy").click(function() { ga("send", "event", "Dev Center Banner", "click", "copy") }), a(".contact-modal").click(function() { ga("send", "event", "Dev Center Modal", "click", "Contact CTA") });
                    var h = Cookies.get("bankBanner");
                    a(window).load(function() { "false" !== h && window.location.href.indexOf("build") > -1 && (a(".build_callout_nav").show(), a(".page-template-template-dev-portal-php .wrap.container").css("margin-top", "170px"), a(".page-template-template-dev-portal-php ul.dev_nav_sidebar").css("top", "180px"), a(".page-template-template-contained-width-php main.main").css("padding-top", "130px"), a(".page-template-template-api-pages main.main").css("padding-top", "55px"), a(".page-ripple-txt-validator .main").css("padding-top", "160px")) });
                    var i = Cookies.get("bankModal");
                    a(window).load(function() { a(document).width() > 767 && "false" !== i && (a("#buildModal").modal("show"), Cookies.set("bankModal", "false", { expires: 365 })) });
                    var j = !1;
                    ...
                    }), a(document).on("scroll", d), a(".sidebar .titleClick").click(function() { a(this).parent().find(".caret").toggleClass("rotate"), a(this).parent().find(".sub_posts").slideToggle(100) }), a(".sidebar .sub_posts").each(function() { a(this).find(".active").length > 0 ? a(this).show() : a(this).hide() }), a(".navbar-header").on("click", ".navbar-toggle", function() { a(".nav_x").toggle(), a(".nav_lines").toggle() }), a(".password_login #wp-submit").prop("disabled", !0), a(".password_login #accept").click(function() { a(".password_login #wp-submit").prop("disabled") ? a(".password_login #wp-submit").prop("disabled", !1) : a(".password_login #wp-submit").prop("disabled", !0) }), a(".dropdown-toggle").click(function() { var b = a(this).attr("href"); return window.location.href = b, !1 }), a("li.dropdown").hover(function() { a(this).find(".dropdown-menu").stop(!0, !0).fadeIn(10) }, function() { a(this).find(".dropdown-menu").stop(!0, !0).fadeOut(10) })
                }
            },
            home: {
                init: function() {
                    function b() { a(".number").each(function(b, c) { c = a(c), c.visible(!0) && setTimeout(function() { e.start(), a(".mm").show() }, 250) }) }

                    function c(b) { a(window).scrollTop() >= b ? (a(".navbar-default").addClass("scrolled"), a(".navbar-default").removeClass("initial_header"), a(".initial_logo").hide(), a(".logo_scrolled").show()) : (a(".navbar-default").removeClass("scrolled"), a(".navbar-default").addClass("initial_header"), a(".initial_logo").show(), a(".logo_scrolled").hide()) }
                    a("#videoModal").on("hidden.bs.modal", function(a) { ga("send", "event", "Watch Video", "close", player.getCurrentTime().toFixed(1)) }), a("a#trigger").click(function() { ga("send", "event", "Watch Video", "click", "CTA") }), a(".video-container .call_to_action").click(function() { ga("send", "event", "Watch Video", "click", "Contact Button"), a(".myblock").toggle() }), a(".insights_btn").click(function() { ga("send", "event", "Insights", "click", "home-cta-button") }), a(".subscribe").click(function() { ga("send", "event", "Insights-Signup", "click", "home-insights-button") }), jQuery.fn.visible = function(b) {
                        var c = a(this),
                            d = a(window),
                            e = d.scrollTop(),
                            f = e + d.height(),
                    ...
                    var d = { useEasing: !1, useGrouping: !1 },
                        e = new CountUp("number1", 0, 200, 0, .5, d);
                    a(window).scroll(function() { b() }), c(10), a(window).scroll(function() { c(10) })
                }
            },
            page_banks: {
                init: function() {
                    ...
                    function d(b) {
                        var c = { labels: w, datasets: [{ label: "Counterparty Fees", data: v, backgroundColor: "#344f5b", hoverBackgroundColor: "#344f5b" }, { label: "Reconciliation Cost", data: u, backgroundColor: "#156d9b", hoverBackgroundColor: "#156d9b" }, { label: "Treasury Cost", data: t, backgroundColor: "#25a2db", hoverBackgroundColor: "#25a2db" }, { label: "Payment Processing Cost", data: s, backgroundColor: "#53c4f1", hoverBackgroundColor: "#53c4f1" }] },
                            d = function(b) {
                                var c = a("#chartjs-tooltip");
                                if (b.opacity || c.css({ opacity: 0 }), c.removeClass("above below"), c.addClass(b.yAlign), void 0 !== b.body) {
                                    var d = b.body[0].lines[0].split(":"),
                                        e = "<span>" + d[0].trim() + '</span>:<br/><span class="number-detail">$' + d[1].trim() + "</span> per payment";
                                    c.html(e), c.css({ opacity: 1, left: b.caretX - 55 + "px", top: b.y + 150 + "px", fontFamily: b.fontFamily, fontSize: b.fontSize, fontStyle: b.fontStyle })
                                }
                            },
                            e = {
                                animation: {
                    ...
                    function e(b, c) {
                        ...
                        if (document.getElementsByClassName("highlight-bar").length && document.getElementsByClassName("highlight-bar")[b]) {
                            ...
                            for (var j = 0; j < i - 1; j++) { document.querySelectorAll("svg #slider_" + (b + 1))[0].children[j].classList.remove("semi-highlight-bar") }
                        }
                        if (Math.ceil(f / c) > 0) {
                        ...
                        for (var l = 0; l < g - 1; l++) { document.querySelectorAll("svg #slider_" + (b + 1))[0].children[l].classList.add("semi-highlight-bar") }
                    ...
                    function i(b, g, h, i, j, k, l, m, n, o, w, x) {
                        ...
                        g = a(h).slider({ min: l, max: m, handle: "custom", tooltip: "always", tooltip_position: "bottom", scale: n, step: o }), e(b, w), x(b), y();
                        var z = !1;
                        ...
                        }), a(h).on("slide", function(c) { x(b), a(j).val(c.value).digits(), e(b, w), y() }), a(h).on("change", function(a) { x(b), e(b, w), y() });
                        var A = !1;
                        a(j).change(function() {
                    ...
                    }), a.fn.digits = function() { return this.each(function() { a(this).text(a(this).text().replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,")), a(this).val(a(this).val().replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,")) }) };
                    var k, l, m, n, o;
                    a(".cost-model-advanced").click(function() { ga("send", "event", "Cost Model", "Click", "View Advanced Settings"), "undefined" != typeof Storage && (localStorage.setItem("slider1", transactionVolume.value), localStorage.setItem("slider2", paymentVolume.value)) });
                    var p, q, r, s = [],
                        t = [],
                        u = [],
                        v = [],
                    ...
                    var y, z, A, B;
                    a('[data-toggle="tooltip"]').tooltip({ placement: "bottom" }), i(0, y, "#transactionVolume", transactionVolume, "#transactionVolumeSliderVal", A, 1e4, 1e8, "logarithmic", 1e3, 2, g), i(1, z, "#paymentVolume", paymentVolume, "#paymentVolumeSliderVal", B, 5e6, 5e12, "logarithmic", 1e5, 2, h), a(window).resize(function() { g(0), h(1), r.destroy(), d(1) }), c(.127, .04, 21700, .24, 2, 2, 2, .05, 1), q = (totalCost / transactionVolume.value).toFixed(2), s = [Number((paymentProcessingCost / transactionVolume.value).toFixed(2))], t = [Number((treasuryCost / transactionVolume.value).toFixed(2))], u = [Number((reconciliationCost / transactionVolume.value).toFixed(2))], v = [Number((counterpartyFees / transactionVolume.value).toFixed(2))], c(0, 0, 0, 0, 2, 1, 0, 0, .2), p = (totalCost / transactionVolume.value).toFixed(2), s.push(Number((paymentProcessingCost / transactionVolume.value).toFixed(2))), t.push(Number((treasuryCost / transactionVolume.value).toFixed(2))), u.push(Number((reconciliationCost / transactionVolume.value).toFixed(2))), v.push(Number((counterpartyFees / transactionVolume.value).toFixed(2)));
                    var C = (q - p).toFixed(2);
                    a("#total-savings").text("$" + C);
                    var D = (C * transactionVolume.value).toFixed(0);
                    a(".annual-savings-number").text("$" + f(D, 2)), b("#saving-bar-chart") && (a("#saving-bar-chart").data("generated", !1), setTimeout(function() { d(1e3) }, 100), a("#saving-bar-chart").data("generated", !0)), a(window).scroll(function() {
                        if (b("#saving-bar-chart")) {
                            if (a("#saving-bar-chart").data("generated")) return;
                            a("#saving-bar-chart").data("generated", !1), setTimeout(function() { d(1e3) }, 100), a("#saving-bar-chart").data("generated", !0)
                        }
                    }), a(".carousel").carousel({ interval: !1 }), a(".partner_logo.standard").addClass("active"), a(".partner_logo").click(function() {
            ...
            page_process_payments: {
                init: function() {
                    a(".carousel").carousel({ interval: !1 }), -1 !== window.location.href.indexOf("#howrippleworks") && a("#techVideoModal").modal("show"), a(".partner_logo.standard").addClass("active"), a(".partner_logo").click(function() {
                        var b = a(this).attr("class").split(" ").pop();
                        a(".partner_logo").removeClass("active"), a(this).addClass("active"), ga("send", "event", "carousel-logo-" + b, "click", "partners")
                    }), a(".carousel-indicators li").click(function() {
                        var b = a(this).index();
                    ...
                    b.prototype = Error.prototype, a("#domain-entry").submit(function(d) {
                        ...
                        a(".result-title").show(), a("#result").show(), a("#log").empty(), async.waterfall([function(d) {
                            function g(f, i) {
                                ...
                                if (!h.length) { return void d(new b("No ripple.txt found!", 'Check if the file is actually hosted at one of the URLs above and make sure your server provides the required <a href="https://ripple.com/wiki/Ripple.txt#Publishing_ripple.txt">CORS header.</a>')) }
                                var k = h.pop(),
                                    l = c("Checking " + k + "...");
                                a.ajax({ url: k, dataType: "text", success: function(b) { a("<span></span>").text("FOUND").addClass("green").appendTo(l), e = b, d() }, error: a.proxy(g, l) })
                            }
            ...
            customer_case_study_reisebank: { init: function() { a("#atbVideoModal").on("hidden.bs.modal", function(a) { ga("send", "event", "Watch ReiseBank Case Study Video", "close", player.getCurrentTime().toFixed(1)) }), a("a#trigger").click(function() { ga("send", "event", "Watch ReiseBank Case Study Video", "click", "Image CTA") }), a(".cta_readmore").click(function() { ga("send", "event", "ReiseBank Case Study", "click", "Download PDF") }), a(".company-info .call_to_action").click(function() { ga("send", "event", "ReiseBank Case Study", "click", "Learn More CTA") }), a(".links li a").click(function() { ga("send", "event", "ReiseBank Case Study", "links-click", a(this).text()) }) } },
            page_all_jobs: {
                init: function() {
                    function b(a) { return a.toString().toLowerCase().trim().replace(/\s+/g, "-").replace(/[^\w\-]+/g, "").replace(/\-\-+/g, "-") }
            ...
            page_contact: {
                init: function() {
                    ...
                    function d() { n.show(), l.show(), m.hide(), o.hide(), p.hide(), j.val("Contact Media Team"), k.text("On deadline?"), r.text("Contact us with your press inquiries.") }

                    function e() { n.hide(), l.hide(), o.show(), p.hide(), q.hide(), k.text("Getting started with XRP?"), r.text("For the fastest answers, check out our FAQs.") }

                    function f() { j.val("Contact Sales"), k.text("Interested in joining RippleNet?"), r.text("Speak with a member of our sales team about joining RippleNet."), m.show(), n.show(), l.hide(), p.hide(), o.hide() }

                    function g() { n.hide(), l.hide(), o.hide(), p.show(), k.text("Can’t find what you are looking for?"), r.text("Our dedicated team is standing by.") }

                    function h() { a("input[type='radio']").click(function() { var b = a("input[type='radio']:checked").val(); "Media & Press" === b ? d() : "XRP" === b ? e() : "Sales" === b ? f() : "Support" === b ? g() : (l.hide(), m.show()) }) }

                    function i(a, b) { var c = a.find(":selected").text(); "Country" === c || "Organization Type" === c ? (a.removeClass("selected"), b && a.addClass("invalid-select")) : (a.addClass("selected"), a.removeClass("invalid-select")) }
                    b(276), a(window).scroll(function() { b(276) }), a(".download + p").remove(), a("input[type=tel]").on("focusout", function(b) { var c = a(this);!new RegExp("^[0-9().+-]+$").test(c.val()) && c.val().length > 0 ? c.addClass("invalid-phone-format") : c.removeClass("invalid-phone-format") }), a("input, input[type=tel]").each(function() { c(this) }), a("input").on("change keyup", function() { c(this) }), a("textarea").each(function() { c(this) }), a("textarea").on("change keyup", function() { c(this) });
                    var j = a(".submit"),
                        k = a(".header_text"),
                        ...
                        q = a(".faq-bottom"),
                        r = a(".teaser_text");
                    h(), window.location.hash || (window.location.hash = "#support"), a('input:radio[name="mail-to"]').change(function() { a(this).is(":checked") && "Media & Press" === a(this).val() ? window.location.hash = "#media" : a(this).is(":checked") && "Sales" === a(this).val() ? window.location.hash = "#sales" : a(this).is(":checked") && "XRP" === a(this).val() ? window.location.hash = "#xrp" : a(this).is(":checked") && "Support" === a(this).val() ? window.location.hash = "#support" : window.location.hash = "#sales" }), window.location.href.indexOf("media") > -1 && (a('input[value="Media & Press"]').prop("checked", !0), d()), window.location.href.indexOf("xrp") > -1 && (a('input[value="XRP"]').prop("checked", !0), e()), window.location.href.indexOf("support") > -1 && (a('input[value="Support"]').prop("checked", !0), g()), window.location.href.indexOf("sales") > -1 && (a('input[value="Sales"]').prop("checked", !0), f());
                    a("#support-holder"), a(".payment-volume");
                    a("#countrySelect, #organizationSelect").on("change", a(this), function() { i(a(this), !1) }), a("form.wpcf7-form").on("submit", function() { i(a("#countrySelect"), !0), i(a("#organizationSelect"), !0) }), document.addEventListener("wpcf7mailsent", function(a) { "5478" === a.detail.contactFormId && (location.replace("/thank-you"), ga("send", "event", "Contact Form", "sent")) }, !1), document.addEventListener("wpcf7spam", function(a) { "5478" === a.detail.contactFormId && alert("Spam detected, please try again.") }, !1), document.addEventListener("wpcf7mailfailed", function(b) { "5478" === b.detail.contactFormId && a(".sending-error").show() }, !1)
                }
            },
            page_xrp_test_net: {
                init: function() {
                    function b() {
                        var b = a("#your-credentials"),
                            ...
                            e = a("#balance"),
                            f = a("#loader");
                        b.hide(), c.html(""), d.html(""), e.html(""), f.css("display", "inline"), a.ajax({ url: "https://faucet.altnet.rippletest.net/accounts", type: "POST", dataType: "json", success: function(a) { f.hide(), b.hide().html("<h2>Your Credentials</h2>").fadeIn("fast"), c.hide().html("<h3>Address</h3> " + a.account.address).fadeIn("fast"), d.hide().html("<h3>Secret</h3> " + a.account.secret).fadeIn("fast"), e.hide().html("<h3>Balance</h3> " + Number(a.balance).toLocaleString("en") + " XRP").fadeIn("fast") }, error: function() { f.hide(), alert("There was an error with the Ripple Test Net, please try again.") } })
                    }
                    a(".cta_readmore").click(b)
                }
            },
            page_bankers_guide_to_blockchain: { init: function() { document.addEventListener("wpcf7mailsent", function(a) { "13265" === a.detail.contactFormId && location.replace("/files/bankers_guide_to_blockchain.pdf") }, !1) } },
            page_blockchain_in_payments_report: { init: function() { document.addEventListener("wpcf7mailsent", function(a) { location.replace("/files/ripple_blockchain_payments_report_2018.pdf") }, !1) } },
            page_market_performance: {
                init: function() {
                                ...
                                Chart.pluginService.register({
                                    ...
                                    afterDraw: function(a, b) {
                                        if (a.config.options.showAllTooltips) {
                                            ...
                                            a.options.tooltips.enabled = !0, Chart.helpers.each(a.pluginTooltips, function(a) { a.initialize(), a.update(), a.pivot(), a.transition(b).draw() }), a.options.tooltips.enabled = !1
                                        }
                                    }
                                });
                                var i, j = { labels: ["Ripple    ", "Distributed", "    Escrow"], datasets: [{ data: [h, f, g], backgroundColor: ["#005f96", "#27a2db", "#344e5a"], hoverBackgroundColor: ["#005f96", "#27a2db", "#344e5a"], borderWidth: 0 }] },
                                    k = { legend: { display: !1 }, cutoutPercentage: 50, showAllTooltips: !0, tooltips: { xPadding: -50, backgroundColor: "rgba(0,0,0,0)", callbacks: { label: function(a, b) { return b.labels[a.index] } } } },
                                    l = a("#myChart").get(0).getContext("2d");
                                a(".ripple-xrp").text(h.toLocaleString()), a(".others-xrp").text(f.toLocaleString() + "*"), a(".escrow-xrp").text(g.toLocaleString()), a(".timestamp").text(e), b("#myChart") && (i = new Chart(l, { type: "doughnut", data: j, options: k }), a("#myChart").data("generated", !0)), a(window).scroll(function() {
                                    if (b("#myChart")) {
                                        if (a("#myChart").data("generated")) return;
                                        a("#myChart").data("generated", !0), setTimeout(function() { i = new Chart(l, { type: "doughnut", data: j, options: k }) }, 350)
                                    }
                                })
                            },
                            error: function(b) { a(".ripple-xrp").text("Currently not available from the Data API"), a(".others-xrp").text("Currently not available from the Data API"), a(".escrow-xrp").text("Currently not available from the Data API"), a(".timestamp").text(moment().format("MMM Do, YY")) }
                        })
                    }
                    ...
                    function e() { a(".xrpValue").removeClass("flash-red"), a(".xrpValue").removeClass("flash-green"), a.ajax("https://data.ripple.com/v2/network/xrp_distribution?descending=true&limit=1", { success: function(b) { l = b.rows[0], A = Number(l.total), m = x * A, m > u ? a(".xrpValue").addClass("flash-green") : m < u && a(".xrpValue").addClass("flash-red"), localStorage.setItem("marketCap", m), u = localStorage.getItem("marketCap"), isNaN(m) ? a(".xrpValue").html('<img class="throbber" src="/wp-content/themes/ripple-beta/assets/img/xrp/rippleThrobber.png" />') : a(".xrpValue").html("<span class='styleDollar'>$</span>" + d(m, 2)) }, error: function() { a(".xrpValue").html('<img class="throbber" src="/wp-content/themes/ripple-beta/assets/img/xrp/rippleThrobber.png" />') } }) }
                    ...
                    function f() {
                        a(".transactionFee").removeClass("flash-red"), a(".transactionFee").removeClass("flash-green"), a.ajax("https://data.ripple.com/v2/network/fees?limit=1&descending=true", {
                            success: function(b) {
                                n = b.rows[0].avg;
                                var c = n * x;
                                c = c.toLocaleString("en", { minimumFractionDigits: 7 }), c > r ? a(".transactionFee").addClass("flash-red") : c < r && a(".transactionFee").addClass("flash-green"), localStorage.setItem("networkTransactionFee", c), r = localStorage.getItem("networkTransactionFee");
                                var d = c.match(/^[^1-9]+/)[0],
                                    e = c.match(/[1-9]+[0-9]*/)[0];
                    ...
                    function h(b) {
                        a(".xrpVolume").removeClass("flash-red"), a(".xrpVolume").removeClass("flash-green"), a.ajax("https://data.ripple.com/v2/exchange_rates/XRP/USD+rvYAfWj5gh67oV6fW32ZzP3Aw4Eubs59B?period=" + b, {
                            success: function(a) { q = Number(a.rate) },
                            error: function() { a(".xrpVolume").html('<img class="throbber" src="/wp-content/themes/ripple-beta/assets/img/xrp/rippleThrobber.png" />') },
                            complete: function() {
                                a.ajax("https://data.ripple.com/v2/network/external_markets?&period=" + b, {
                                    success: function(a) { y = Number(a.data.total) },
                                    error: function() { a(".xrpVolume").html('<img class="throbber" src="/wp-content/themes/ripple-beta/assets/img/xrp/rippleThrobber.png" />') },
                                    complete: function() {
                                        z = 0, a.ajax("https://data.ripple.com/v2/network/exchange_volume?&live=" + b, {
                                            success: function(b) {
                                                a.each(b.rows[0].components, function(a, b) { "XRP" !== b.base.currency && "XRP" !== b.counter.currency || (z += Number(b.converted_amount)) }), A = Number(z + y);
                                                var c = A * q;
                    ...
                    function i() {
                        ...
                        a(".xrpNumber").removeClass("flash-red"), a(".xrpNumber").removeClass("flash-green"), a.ajax("https://data.ripple.com/v2/exchange_rates/XRP/USD+rvYAfWj5gh67oV6fW32ZzP3Aw4Eubs59B?live=true", {
                            ...
                            error: function() { a(".xrpNumber").html('<img class="throbber" src="/wp-content/themes/ripple-beta/assets/img/xrp/rippleThrobber.png" />') }
                        }), a.ajax("https://data.ripple.com/v2/exchange_rates/XRP/USD+rvYAfWj5gh67oV6fW32ZzP3Aw4Eubs59B?live=true", { success: function(a) { k = Number(a.rate).toPrecision(4), g() }, error: function() { a(".xrpNumber").html('<img class="throbber" src="/wp-content/themes/ripple-beta/assets/img/xrp/rippleThrobber.png" />') } })
                    }

                    function j(b) { a(window).scrollTop() >= b ? (a(".navbar-default").addClass("scrolled"), a(".navbar-default").removeClass("initial_header"), a(".initial_logo").hide(), a(".logo_scrolled").show()) : (a(".navbar-default").removeClass("scrolled"), a(".navbar-default").addClass("initial_header"), a(".initial_logo").show(), a(".logo_scrolled").hide()) }
                    a('[data-toggle="tooltip"]').tooltip({ placement: "top" }), Chart.defaults.global.defaultFontFamily = "'open_sansregular', sans-serif", Chart.defaults.global.defaultFontSize = 17, c();
                    var k, l, m, n, o, p, q, r, s, t, u, v, w, x = 0,
                        ...
                        B = "30day",
                        C = !0;
                    j(10), a(window).scroll(function() { j(10) }), a("#timeLinks a").click(function(b) {
                    ...
                    }), i(), window.setInterval(function() { x = 0, i() }, 4e3)
                }
            },
            page_buy_xrp: {
                init: function() {
                    function b(b) { a(window).scrollTop() >= b ? (a(".navbar-default").addClass("scrolled"), a(".navbar-default").removeClass("initial_header"), a(".initial_logo").hide(), a(".logo_scrolled").show()) : (a(".navbar-default").removeClass("scrolled"), a(".navbar-default").addClass("initial_header"), a(".initial_logo").show(), a(".logo_scrolled").hide()) }
                    a("a").click(function(b) {
                        var c = a(this).text();
                        ga("send", "event", "XRP", "click", c)
                    }), b(10), a(window).scroll(function() { b(10) })
                }
            },
            ...
            page_xrp: {
                init: function() {
                    ...
                    function e() { a.ajax("https://data.ripple.com/v2/network/external_markets?&period=30day", { success: function(a) { k = Number(a.data.total) }, error: function() { a("#xrpVolume").html('<img class="throbber" src="/wp-content/themes/ripple-beta/assets/img/xrp/rippleThrobber.png" />') } }) }

                    function f() {
                        a.ajax("https://data.ripple.com/v2/network/exchange_volume?&live=30day", {
                            success: function(b) {
                                a.each(b.rows[0].components, function(a, b) { "XRP" !== b.base.currency && "XRP" !== b.counter.currency || (l += Number(b.converted_amount)) }), m = Number(l + k);
                                var c = m * i;
                    ...
                    }), b(10), a(window).scroll(function() { b(10) }), a('[data-toggle="tooltip"]').tooltip({ placement: "top" }), a(window).scrollTop() < 50 && setTimeout(function() { a(".scroll-icon").fadeIn("slow") }, 500), setTimeout(function() { a(".parallax-container").css("opacity", "1") }, 200), a(document).scroll(function() {
                        var b = a(document).scrollTop();
                        b >= 280 && b <= 600 ? a(".floor").addClass("changed") : a(".floor").removeClass("changed")
                    }), a(window).scroll(function() { a(".scroll-icon").fadeOut("slow") }), a(".scroll-icon").click(function(b) { ga("send", "event", "XRP", "click", "Scroller-Icon"), a(".leader-wrapper").css("visibility", "visible") }), a(window).scroll(function() { c(".animate-graph") && (a("#skills").show(), a(".time-label").fadeIn(), a(".bar").addClass("bar-animate")) });
                    var h = !1;
                    a(window).scroll(function() { c(".scalable-wrapper") && !h && (h = !0) }), a(".scroll-icon").click(function() { a("html, body").animate({ scrollTop: a(window).scrollTop() + 600 }, 2e3) });
                    var i, j = 0,
                        k = 0,
                        l = 0,
                        m = 0,
                    ...
                    a.ajax("https://data.ripple.com/v2/ledgers", {
                        success: function(b) {
                            function c() { d += 1, a("#ledgerNumber").text(d.toLocaleString("en")) }
                            n = b.ledger.ledger_index, a("#ledgerNumber").text(n.toLocaleString("en"));
                            var d = Number(n);
                            setInterval(c, 4e3)
                        },
                        error: function() { a("#ledgerNumber").text("29+ Million") }
                    }), e(), a.ajax("https://data.ripple.com/v2/exchange_rates/XRP/USD+rvYAfWj5gh67oV6fW32ZzP3Aw4Eubs59B?period=30day", { success: function(a) { i = Number(a.rate), f() }, error: function() { a("#xrpVolume").html('<img class="throbber" src="/wp-content/themes/ripple-beta/assets/img/xrp/rippleThrobber.png" />') } }), a.ajax("https://data.ripple.com/v2/exchange_rates/XRP/USD+rvYAfWj5gh67oV6fW32ZzP3Aw4Eubs59B?live=true", {
                        success: function(b) {
                            var c;
                        ...
                        error: function() { a("#xrpPrice").html('<img class="throbber" src="/wp-content/themes/ripple-beta/assets/img/xrp/rippleThrobber.png" />') }
                    })
                }
            },
            page_cost_model: {
                init: function() {
                    ...
                    function c(b) {
                        var c = { labels: B, datasets: [{ label: "Counterparty Fees", data: A, backgroundColor: "#344f5b", hoverBackgroundColor: "#344f5b" }, { label: "Reconciliation Cost", data: z, backgroundColor: "#156d9b", hoverBackgroundColor: "#156d9b" }, { label: "Treasury Cost", data: y, backgroundColor: "#25a2db", hoverBackgroundColor: "#25a2db" }, { label: "Payment Processing Cost", data: x, backgroundColor: "#53c4f1", hoverBackgroundColor: "#53c4f1" }] },
                            d = function(b) {
                                var c = a("#chartjs-tooltip");
                                if (b.opacity || c.css({ opacity: 0 }), c.removeClass("above below"), c.addClass(b.yAlign), void 0 !== b.body) {
                                    var d = b.body[0].lines[0].split(":"),
                            ...
                            f = a("#saving-bar-chart");
                        w = new Chart(f, { type: "bar", data: c, options: e })
                    }
                    ...
                    function k(f, g, h, i, j, k, l, m, n, o, p, q) {
                        ...
                        g = a(h).slider({ min: l, max: m, handle: "custom", tooltip: "always", tooltip_position: "bottom", scale: n, step: o }), d(f, p), q(f), r();
                        var t = !1;
                        a(h).on("slideStop", function(g) {
                        ...
                        }), a(h).on("change", function(a) { q(f), d(f, p), s() });
                        var B = !1;
                        a(j).change(function() {
                    ...
                    function m() {
                        ...
                        }), a.ajax({ type: "POST", url: "/wp-content/themes/ripple-beta/jenkins/send.php", data: c, success: function(a, b, c) {}, error: function(a, b, c) { ga("send", "event", "Cost Model", "Send", "PDF Error", "Full Cost Model page") } })
                    }
                    document.addEventListener("wpcf7mailsent", function(a) { "13897" === a.detail.contactFormId && location.replace("/thank-you") }, !1), a.fn.digits = function() { return this.each(function() { a(this).text(a(this).text().replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,")), a(this).val(a(this).val().replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,")) }) };
                    var n = a(".page-header").offset().top,
                        o = a(window);
                    o.scroll(function() { o.scrollTop() >= n ? a(".savings-sidebar").addClass("sidebar-fixed") : o.scrollTop() <= n && a(".savings-sidebar").removeClass("sidebar-fixed") }), o.scroll(function() { o.scrollTop() > 1880 ? (a(".savings-sidebar").removeClass("sidebar-fixed"), a(".savings-sidebar").addClass("sidebar-fixed-2")) : a(".savings-sidebar").removeClass("sidebar-fixed-2") });
                    ...
                    a(".annual-savings-number").text("$" + e($, 2)), a("#saving-bar-chart").data("generated", !1), setTimeout(function() { c(1e3) }, 100), a("#saving-bar-chart").data("generated", !0);
                    ...
                    var xa;
                    a("#roi-form").on("wpcf7:mailsent", function(b) { email = a(".your-email input").val(), xa = a(".org-650 input").val(), ga("send", "event", "Cost Model", "Send", "PDF Sent"), ga("send", "event", "Cost Model", "Slider", "Cost savings per payment", ka), ga("send", "event", "Cost Model", "Slider", "Ripple cost per payment", u), ga("send", "event", "Cost Model", "Slider", "Current cost per payment", v), ga("send", "event", "Cost Model", "Slider", "Annual Savings", $), m() });
                    var ya = [];
            ...
            page_careers: {
                init: function() {
                    a(".carousel").carousel({ interval: !1 }), a(".carousel").swiperight(function() { a(this).carousel("prev") }), a(".carousel").swipeleft(function() { a(this).carousel("next") }), a(".careers_cta").click(function() { ga("send", "event", "CTA-careers", "click") }), a("#career-carousel ol.carousel-indicators li").click(function() {
                ...
                init: function() {
                    function b() {
                        ...
                        if (a(document).width() < 992) {
                            ...
                            d.collapse({ toggle: !1 });
                            var e = !0;
                            a(".menu-active-filter, .blog-menu-dropdown li").on("click", function(a) { a.preventDefault(), e ? (d.collapse("toggle"), e = !1) : (d.collapse("toggle"), e = !0) })
                    ...
                    b(), c(), d(), a(window).resize(function() { b(), d() })
                }
            },
            single_post: {
                init: function() {
                    ...
                    function c() {
                        ...
                        var g = a(".navbar").outerHeight(!0),
                            ...
                            j = b + d;
                        b > f ? j > h ? c.css({ position: "absolute", top: -(d + i) }) : c.css({ position: "fixed", top: g + e }) : c.css({ position: "absolute" })
                    }
                    ...
                    c(), d(), a(window).scroll(function() { b(), c() }), a(window).resize(function() { c(), d() })
                }
            }
        },
        c = {
            ...
            loadEvents: function() { c.fire("common"), a.each(document.body.className.replace(/-/g, "_").split(/\s+/), function(a, b) { c.fire(b) }) }
        };
